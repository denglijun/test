...
var blindnum = new Promise(function (resolve, reject) {
    db.query(sqls.blindnum,[],function(err,result) {
       if ( !err ) {
           resolve(result);
       }
    });
...
var friendsnum = new Promise(function (resolve, reject) {
    db.query(sqls.friendsnum,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var volunteersnum = new Promise(function (resolve, reject) {
    db.query(sqls.volunteersnum,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var customersnum = new Promise(function (resolve,reject) {
    db.query(sqls.customersnum,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var daycallangel = new Promise(function (resolve,reject) {
    db.query(sqls.daycallangel,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var daycallvo = new Promise(function (resolve,reject) {
    db.query(sqls.daycallvo,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var daycallcus = new Promise(function (resolve,reject) {
    db.query(sqls.daycallcus,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var daycallnum = new Promise(function (resolve,reject) {
    db.query(sqls.daycallnum,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var dayanswernum =  new Promise(function (resolve,reject) {
    db.query(sqls.dayanswernum,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var daychatnum =  new Promise(function (resolve,reject) {
    db.query(sqls.daychatnum,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var friendaudio = new Promise(function (resolve,reject) {
    db.query(sqls.friendaudio,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var blindaudio = new Promise(function (resolve,reject) {
    db.query(sqls.blindaudio,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
var blindvideo = new Promise(function (resolve,reject) {
    db.query(sqls.blindvideo,[],function(err,result) {
        if ( !err ) {
            resolve(result);
        }
     });
...
db.query(sqls.bTf,[],function(err,result) {
    if ( err ) throw err;
...
db.query(sqls.fTb,[],function(err,result) {
    if ( err ) throw err;
    for ( var i in result ) {
...
db.query(sqls.answerfail,[],function(err,result) {
    if (err) throw err;
    for( var k in result ) {
